...
# using math.ceil here only because the distance between stones is so close to 45 pixels that we won't have an issue
# rounding the distance between the stones
...
path_to_image = r"C:\Users\nharw\Desktop\Situation puzzles\Colin 8 2023-02-09.png"
...
# below numbers are hard coded, it's bad, see OGS_image2SGF for better code
